...
export declare class APIPromise<T> extends Promise<T> {
    ...
    constructor(client: BrowsercashSDK, responsePromise: Promise<APIResponseProps>, parseResponse?: (client: BrowsercashSDK, props: APIResponseProps) => PromiseOrValue<T>);
